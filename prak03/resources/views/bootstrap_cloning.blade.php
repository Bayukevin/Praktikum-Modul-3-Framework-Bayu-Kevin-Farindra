    ...
    <nav class="navbar navbar-expand-lg bg-purple fixed-top" data-bs-theme="dark">
      <div class="container">
        <a href="#" class="navbar-brand">
          <img src="{{
            Vite::asset('resources/images/logo-white.svg') }}" alt="bootstrap-logo" />
        </a>
            ...
            <div class="row">
                ...
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="{{
                        Vite::asset('resources/images/main.svg') }}" alt="image bootstrap logo">
                </div>
            </div>
        </div>
    </section>
        ...
        <div id="bs-icons">
            ...
            <div class="container py-5 px-4">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid" src="{{
                            Vite::asset('resources/images/bs-icons.png') }}" alt="Bootstrap Icons">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="bs-themes">
            <div class="container py-5 px-4">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid" src="{{
                            Vite::asset('resources/images/bs-themes.png') }}" alt="Bootstrap Themes">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-fluid" src="{{
                                Vite::asset('resources/images/logo-black.svg') }}" alt="Bootstrap Logo" style="width: 40px;">
