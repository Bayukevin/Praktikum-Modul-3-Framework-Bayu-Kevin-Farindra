...
Route::get('/bootstrap_cloning', function () {
    return view('bootstrap_cloning');
});
...
Route::view('/view_route', 'view_route', ['name' => 'Kevin']);
...
Route::get('username/{name?}', function ($name = 'Kevin') {
